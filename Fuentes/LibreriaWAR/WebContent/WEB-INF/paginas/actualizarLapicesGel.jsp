...
<main class="container">
	...
	<div class="columns is-centered is-multiline mt-5">
		...
		<div class="column is-7">
			<form method="POST" action="ActualizarLapicesGelController.do">
				<div class="card">
					<div class="card-header has-background-info-light">
						<span class="card-header-title">Ingresar Lapiz Gel</span>
						</div>
							<c items="${lapizGelEditado}" var="lapizGelEditado">
							...
							<div class="control">
								...
								<input type="text" name=idTxt class="input" value="${lapizGelEditado.idLapizGel}" readonly/>
						...
						<div class="field">
							...
							<div class="control">
								...
								<input type="text" name=nombreTxt class="input" required value="${lapizGelEditado.nombre}"/>
						...
						<div class="field">
							...
							<div class="control has-icons-left">
								...
								<input type="number" min="100" name=precioTxt class="input" required value="${lapizGelEditado.precio}" /> 
								<span
						...
						<div class="field">
							...
							<div class="control">
								<input type="number" min="1" name=cantidadTxt class="input" required value="${lapizGelEditado.cantidad}" />
							</div>
						</div>
